...
export default function DynamicSignature({ html, data }) {
    ...
    const placeholders = {
        ...
        photoUrl: data.photoUrl || 'https://maguissa.com/wp-content/uploads/profile-fallback.jpeg'
    };
    ...
    Object.keys(placeholders).forEach(key => {
        ...
        // Use a function as the second argument to replace() to treat the replacement string literally
